...
2. **彻底解决“AI变脸”**：首创“定妆室”生成唯一面部锚点，后续视频无缝挂载。
3. **拒绝背景乱飘**：引入 `{@场景}` 黑魔法，强行钉死物理背景坐标，杜绝基因突变。
4. **一站式文件管理**：项目制管理，音频、视频、图片、脚本全部自动归档，告别“桌面垃圾堆”。
...
👉 **[点击查看：新手保姆级教程 (Tutorial)](./docs/tutorial.md)**
...
👉 **[点击查看：底层架构与开发手册 (Architecture)](./docs/architecture.md)**
