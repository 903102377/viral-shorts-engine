        ...
        <div className={`p-4 rounded-xl border transition-all flex flex-col gap-3 ${currentPhase === 2 ? 'bg-neutral-900 border-purple-900/40 shadow-lg shadow-purple-900/10' : 'bg-neutral-950 border-neutral-800 opacity-60 pointer-events-none'}`}>
            ...
            {currentPhase === 2 && (
                <div className="flex flex-col gap-2">
                    ...
                    >
                        {isProcessingLocation === 'prompt' ? "🔍 提取场景提示词..." : "从剧本中提取场景英文 Prompt"}
                    </button>
                    <textarea
            ...
            {currentPhase === 2 && (
                ...
                >
                    {isProcessingLocation === 'image' ? "Nano Pro 绘制中..." : "根据 Prompt 生成场景图"}
                </button>
            )}
        </div>
                        ...
                        <>
                            {currentPhase === 2 && (
                                <div className="flex flex-col gap-2">
                                    ...
                                    >
                                        {processingChars[i] === 'prompt' ? "🔍 AI 正在纵观全剧提取人设..." : "从剧本上下文中提取外表英文 Prompt"}
                                    </button>
                                    <textarea
                            ...
                            {currentPhase === 2 && (
                                ...
                                >
                                    {processingChars[i] === 'image' ? "Nano Pro 绘制中..." : "根据 Prompt 生成 4 视图渲染图"}
                                </button>
                            )}
                        </>
                    );
